...
public:
	...
	void SortTrailingEvents(TArray<FChaosTrailingEventData>& TrailingEvents, EChaosTrailingSortMethod SortMethod);           // [0x4677a30] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SortCollisionEvents
	void SortCollisionEvents(TArray<FChaosCollisionEventData>& CollisionEvents, EChaosCollisionSortMethod SortMethod);       // [0x4677930] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SortBreakingEvents
	void SortBreakingEvents(TArray<FChaosBreakingEventData>& BreakingEvents, EChaosBreakingSortMethod SortMethod);           // [0x4677830] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventRequestSettings
	void SetTrailingEventRequestSettings(FChaosTrailingEventRequestSettings& InSettings);                                    // [0x4677790] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventEnabled
	void SetTrailingEventEnabled(bool bIsEnabled);                                                                           // [0x4677700] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetCollisionEventRequestSettings
	void SetCollisionEventRequestSettings(FChaosCollisionEventRequestSettings& InSettings);                                  // [0x46775d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetCollisionEventEnabled
	void SetCollisionEventEnabled(bool bIsEnabled);                                                                          // [0x4677540] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetBreakingEventRequestSettings
	void SetBreakingEventRequestSettings(FChaosBreakingEventRequestSettings& InSettings);                                    // [0x46774a0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetBreakingEventEnabled
	void SetBreakingEventEnabled(bool bIsEnabled);                                                                           // [0x4677410] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.RemoveGeometryCollectionActor
	void RemoveGeometryCollectionActor(AGeometryCollectionActor* GeometryCollectionActor);                                   // [0x4677380] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.RemoveChaosSolverActor
	void RemoveChaosSolverActor(AChaosSolverActor* ChaosSolverActor);                                                        // [0x23b4530] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.IsEventListening
	bool IsEventListening();                                                                                                 // [0x4677090] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.AddGeometryCollectionActor
	void AddGeometryCollectionActor(AGeometryCollectionActor* GeometryCollectionActor);                                      // [0x4676da0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.AddChaosSolverActor
	void AddChaosSolverActor(AChaosSolverActor* ChaosSolverActor);                                                           // [0x23b4530] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	bool RaycastSingle(FVector Start, FVector End, FHitResult& OutHit);                                                      // [0x4677200] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x0480 (0x000480 - 0x000900)
class UGeometryCollectionComponent : public UMeshComponent
{ 
public:
	AChaosSolverActor*                                 ChaosSolverActor;                                           // 0x0480   (0x0008)  
	unsigned char                                      UnknownData00_5[0xE0];                                      // 0x0488   (0x00E0)  MISSED
	UGeometryCollection*                               RestCollection;                                             // 0x0568   (0x0008)  
	TArray<AFieldSystemActor*>                         InitializationFields;                                       // 0x0570   (0x0010)  
	...
	unsigned char                                      UnknownData03_5[0x4];                                       // 0x0594   (0x0004)  MISSED
	TArray<float>                                      DamageThreshold;                                            // 0x0598   (0x0010)  
	EClusterConnectionTypeEnum                         ClusterConnectionType;                                      // 0x05A8   (0x0001)  
	unsigned char                                      UnknownData04_5[0x3];                                       // 0x05A9   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData05_5[0x4];                                       // 0x05BC   (0x0004)  MISSED
	UChaosPhysicalMaterial*                            PhysicalMaterial;                                           // 0x05C0   (0x0008)  
	EInitialVelocityTypeEnum                           InitialVelocityType;                                        // 0x05C8   (0x0001)  
	unsigned char                                      UnknownData06_5[0x3];                                       // 0x05C9   (0x0003)  MISSED
	FVector                                            InitialLinearVelocity;                                      // 0x05CC   (0x000C)  
	FVector                                            InitialAngularVelocity;                                     // 0x05D8   (0x000C)  
	unsigned char                                      UnknownData07_5[0x4];                                       // 0x05E4   (0x0004)  MISSED
	UPhysicalMaterial*                                 PhysicalMaterialOverride;                                   // 0x05E8   (0x0008)  
	FGeomComponentCacheParameters                      CacheParameters;                                            // 0x05F0   (0x0050)  
	FMulticastInlineDelegate                           NotifyGeometryCollectionPhysicsStateChange;                 // 0x0640   (0x0010)  
	FMulticastInlineDelegate                           NotifyGeometryCollectionPhysicsLoadingStateChange;          // 0x0650   (0x0010)  
	unsigned char                                      UnknownData08_5[0x18];                                      // 0x0660   (0x0018)  MISSED
	FMulticastInlineDelegate                           OnChaosBreakEvent;                                          // 0x0678   (0x0010)  
	float                                              DesiredCacheTime;                                           // 0x0688   (0x0004)  
	bool                                               CachePlayback;                                              // 0x068C   (0x0001)  
	unsigned char                                      UnknownData09_5[0x3];                                       // 0x068D   (0x0003)  MISSED
	FMulticastInlineDelegate                           OnChaosPhysicsCollision;                                    // 0x0690   (0x0010)  
	...
	unsigned char                                      UnknownData10_5[0x218];                                     // 0x06C0   (0x0218)  MISSED
	UBodySetup*                                        DummyBodySetup;                                             // 0x08D8   (0x0008)  
	unsigned char                                      UnknownData11_6[0x20];                                      // 0x08E0   (0x0020)  MISSED


	/// Functions
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.SetNotifyBreaks
	void SetNotifyBreaks(bool bNewNotifyBreaks);                                                                             // [0x4677670] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ReceivePhysicsCollision
	void ReceivePhysicsCollision(FChaosPhysicsCollisionInfo& CollisionInfo);                                                 // [0x2859740] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.OnRep_RepData
	void OnRep_RepData(FGeometryCollectionRepData& OldData);                                                                 // [0x4677150] Final|Native|Protected|HasOutParms 
	...
	void NotifyGeometryCollectionPhysicsStateChange__DelegateSignature(UGeometryCollectionComponent* FracturedComponent);    // [0x2859740] MulticastDelegate|Public|Delegate 
	...
	void NotifyGeometryCollectionPhysicsLoadingStateChange__DelegateSignature(UGeometryCollectionComponent* FracturedComponent); // [0x2859740] MulticastDelegate|Public|Delegate 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.NetAbandonCluster
	void NetAbandonCluster(int32_t TransformIndex);                                                                          // [0x46770c0] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ApplyPhysicsField
	void ApplyPhysicsField(bool Enabled, EGeometryCollectionPhysicsTypeEnum Target, UFieldSystemMetaData* MetaData, UFieldNodeBase* Field); // [0x4676f10] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ApplyKinematicField
	void ApplyKinematicField(float Radius, FVector position);                                                                // [0x4676e30] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	unsigned char                                      UnknownData06_5[0x4];                                       // 0x00A4   (0x0004)  MISSED
	...
	TArray<UMaterialInterface*>                        RemoveOnFractureMaterials;                                  // 0x00C0   (0x0010)  
	FGuid                                              PersistentGuid;                                             // 0x00D0   (0x0010)  
	FGuid                                              StateGuid;                                                  // 0x00E0   (0x0010)  
	int32_t                                            BoneSelectedMaterialIndex;                                  // 0x00F0   (0x0004)  
	unsigned char                                      UnknownData08_6[0x14];                                      // 0x00F4   (0x0014)  MISSED
};
...
public:
	...
	void ForceRecreatePhysicsState();                                                                                        // [0x4677070] Final|Native|Public|BlueprintCallable 
};
