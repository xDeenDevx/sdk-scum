...
public:
	...
	void GetInstancedActors(TArray<AActor*>& Actors);                                                                        // [0x1718630] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	void RegisterActorWithSkeletonBP(AActor* InActor, USkeleton* SharingSkeleton);                                           // [0x17188a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.GetAnimationSharingManager
	UAnimationSharingManager* GetAnimationSharingManager(UObject* WorldContextObject);                                       // [0x1718570] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.CreateAnimationSharingManager
	bool CreateAnimationSharingManager(UObject* WorldContextObject, UAnimationSharingSetup* Setup);                          // [0x17184a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.AnimationSharingEnabled
	bool AnimationSharingEnabled();                                                                                          // [0x1718470] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	void ProcessActorState(int32_t& OutState, AActor* InActor, char CurrentState, char OnDemandState, bool& bShouldProcess); // [0x17186e0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AnimationSharing.AnimationSharingStateProcessor.GetAnimationStateEnum
	UEnum* GetAnimationStateEnum();                                                                                          // [0x1718600] Native|Event|Public|BlueprintEvent 
};
