...
public:
	...
	USplineComponent* GetRailSplineComponent();                                                                              // [0x3b57920] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UCineCameraComponent* GetCineCameraComponent();                                                                          // [0x3b57550] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	unsigned char                                      UnknownData00_5[0xC];                                       // 0x0864   (0x000C)  MISSED
	...
	void SetLensPresetByName(FString InPresetName);                                                                          // [0x3b57a90] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.SetFilmbackPresetByName
	void SetFilmbackPresetByName(FString InPresetName);                                                                      // [0x3b579f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.SetCurrentFocalLength
	void SetCurrentFocalLength(float InFocalLength);                                                                         // [0x3b57970] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetVerticalFieldOfView
	float GetVerticalFieldOfView();                                                                                          // [0x3b57940] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetLensPresetsCopy
	TArray<FNamedLensPreset> GetLensPresetsCopy();                                                                           // [0x3b57840] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetLensPresetName
	FString GetLensPresetName();                                                                                             // [0x3b577c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetHorizontalFieldOfView
	float GetHorizontalFieldOfView();                                                                                        // [0x3b57790] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetFilmbackPresetsCopy
	TArray<FNamedFilmbackPreset> GetFilmbackPresetsCopy();                                                                   // [0x3b576b0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetFilmbackPresetName
	FString GetFilmbackPresetName();                                                                                         // [0x3b57630] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetDefaultFilmbackPresetName
	FString GetDefaultFilmbackPresetName();                                                                                  // [0x3b57570] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
