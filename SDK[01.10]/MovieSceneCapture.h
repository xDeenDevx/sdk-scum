...
public:
	...
	bool IsCapturing();                                                                                                      // [0x3cdc100] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieSceneCapture.MovieSceneCaptureProtocolBase.GetState
	EMovieSceneCaptureProtocolState GetState();                                                                              // [0x35f4700] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void SetImageCaptureProtocolType(UClass* ProtocolType);                                                                  // [0x3cdc3b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.MovieSceneCapture.SetAudioCaptureProtocolType
	void SetAudioCaptureProtocolType(UClass* ProtocolType);                                                                  // [0x3cdc320] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.MovieSceneCapture.GetImageCaptureProtocol
	UMovieSceneCaptureProtocolBase* GetImageCaptureProtocol();                                                               // [0x3cdc0b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.MovieSceneCapture.GetAudioCaptureProtocol
	UMovieSceneCaptureProtocolBase* GetAudioCaptureProtocol();                                                               // [0x3cdc010] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	void StopCapturingFinalPixels();                                                                                         // [0x3cdc580] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.StartCapturingFinalPixels
	void StartCapturingFinalPixels(FCapturedPixelsID& streamId);                                                             // [0x3cdc440] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.ResolveBuffer
	void ResolveBuffer(UTexture* Buffer, FCapturedPixelsID& BufferID);                                                       // [0x3cdc1a0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnWarmUp
	void OnWarmUp();                                                                                                         // [0x2859740] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnTick
	void OnTick();                                                                                                           // [0x2859740] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnStartCapture
	void OnStartCapture();                                                                                                   // [0x2859740] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnSetup
	bool OnSetup();                                                                                                          // [0x3cdc170] Native|Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnPreTick
	void OnPreTick();                                                                                                        // [0x2859740] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnPixelsReceived
	void OnPixelsReceived(FCapturedPixels& Pixels, FCapturedPixelsID& ID, FFrameMetrics FrameMetrics);                       // [0x2859740] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnPauseCapture
	void OnPauseCapture();                                                                                                   // [0x2859740] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnFinalize
	void OnFinalize();                                                                                                       // [0x2859740] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnCaptureFrame
	void OnCaptureFrame();                                                                                                   // [0x2859740] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnCanFinalize
	bool OnCanFinalize();                                                                                                    // [0x3cdc140] Native|Event|Protected|BlueprintEvent|Const 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnBeginFinalize
	void OnBeginFinalize();                                                                                                  // [0x2859740] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.GetCurrentFrameMetrics
	FFrameMetrics GetCurrentFrameMetrics();                                                                                  // [0x3cdc090] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.GenerateFilename
	FString GenerateFilename(FFrameMetrics& InFrameMetrics);                                                                 // [0x3cdbce0] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void WriteImageToDisk(FCapturedPixels& PixelData, FCapturedPixelsID& streamId, FFrameMetrics& FrameMetrics, bool bCopyImageData); // [0x3cdc5a0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedImageCaptureProtocol.GenerateFilenameForCurrentFrame
	FString GenerateFilenameForCurrentFrame();                                                                               // [0x3cdbf90] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedImageCaptureProtocol.GenerateFilenameForBuffer
	FString GenerateFilenameForBuffer(UTexture* Buffer, FCapturedPixelsID& streamId);                                        // [0x3cdbdd0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
