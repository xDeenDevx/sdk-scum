...
{ 
public:
	FMulticastInlineDelegate                           OnInstanceTakePointDamage;                                  // 0x0678   (0x0010)  
	FMulticastInlineDelegate                           OnInstanceTakeRadialDamage;                                 // 0x0688   (0x0010)  
...
public:
	...
	bool                                               bVisibleInRayTracing;                                       // 0x0158:0 (0x0001)  
	bool                                               bEvaluateWorldPositionOffset;                               // 0x0158:1 (0x0001)  
	...
	unsigned char                                      UnknownData14_5[0x2];                                       // 0x02BA   (0x0002)  MISSED
	bool                                               bRenderCustomDepth;                                         // 0x02BC:0 (0x0001)  
	unsigned char                                      UnknownData15_4[0x3];                                       // 0x02BD   (0x0003)  MISSED
	ERendererStencilMask                               CustomDepthStencilWriteMask;                                // 0x02C0   (0x0001)  
	unsigned char                                      UnknownData16_5[0x3];                                       // 0x02C1   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData17_5[0x2];                                       // 0x02F2   (0x0002)  MISSED
	...
	bool                                               ReapplyDensity;                                             // 0x0394:0 (0x0001)  
	bool                                               ReapplyRadius;                                              // 0x0394:1 (0x0001)  
	bool                                               ReapplyAlignToNormal;                                       // 0x0394:2 (0x0001)  
	bool                                               ReapplyRandomYaw;                                           // 0x0394:3 (0x0001)  
	bool                                               ReapplyScaling;                                             // 0x0394:4 (0x0001)  
	bool                                               ReapplyScaleX;                                              // 0x0394:5 (0x0001)  
	bool                                               ReapplyScaleY;                                              // 0x0394:6 (0x0001)  
	bool                                               ReapplyScaleZ;                                              // 0x0394:7 (0x0001)  
	bool                                               ReapplyRandomPitchAngle;                                    // 0x0395:0 (0x0001)  
	bool                                               ReapplyGroundSlope;                                         // 0x0395:1 (0x0001)  
	bool                                               ReapplyHeight;                                              // 0x0395:2 (0x0001)  
	bool                                               ReapplyLandscapeLayers;                                     // 0x0395:3 (0x0001)  
	bool                                               ReapplyZOffset;                                             // 0x0395:4 (0x0001)  
	bool                                               ReapplyCollisionWithWorld;                                  // 0x0395:5 (0x0001)  
	bool                                               ReapplyVertexColorMask;                                     // 0x0395:6 (0x0001)  
	bool                                               bEnableDensityScaling;                                      // 0x0395:7 (0x0001)  
	bool                                               bEnableDiscardOnLoad;                                       // 0x0396:0 (0x0001)  
	unsigned char                                      UnknownData18_4[0x1];                                       // 0x0397   (0x0001)  MISSED
	TArray<URuntimeVirtualTexture*>                    RuntimeVirtualTextures;                                     // 0x0398   (0x0010)  
	...
	unsigned char                                      UnknownData19_6[0x3];                                       // 0x03AD   (0x0003)  MISSED
};
...
{ 
public:
	UClass*                                            ActorClass;                                                 // 0x03B0   (0x0008)  
...
{ 
public:
	UStaticMesh*                                       Mesh;                                                       // 0x03B0   (0x0008)  
	TArray<UMaterialInterface*>                        OverrideMaterials;                                          // 0x03B8   (0x0010)  
	UClass*                                            ComponentClass;                                             // 0x03C8   (0x0008)  
};
...
public:
	...
	void CapsuleTouched(UPrimitiveComponent* OverlappedComp, AActor* Other, UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x383f8c0] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	void Simulate(int32_t NumSteps);                                                                                         // [0x383fd70] Final|Native|Public|BlueprintCallable 
};
