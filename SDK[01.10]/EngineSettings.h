...
public:
	...
	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer);                                                            // [0x309bf30] Final|Native|Public|BlueprintCallable 
	// Function /Script/EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1
	bool GetSkipAssigningGamepadToPlayer1();                                                                                 // [0x309bf00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EngineSettings.GameMapsSettings.GetGameMapsSettings
	UGameMapsSettings* GetGameMapsSettings();                                                                                // [0x309bed0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
