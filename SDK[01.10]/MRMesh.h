...
public:
	...
	void OnMockDataMeshTrackerUpdated__DelegateSignature(int32_t Index, TArray<FVector>& Vertices, TArray<int32_t>& Triangles, TArray<FVector>& Normals, TArray<float>& Confidence); // [0x2859740] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MRMesh.MockDataMeshTrackerComponent.DisconnectMRMesh
	void DisconnectMRMesh(UMRMeshComponent* InMRMeshPtr);                                                                    // [0x35cbb80] Final|Native|Public|BlueprintCallable 
	// Function /Script/MRMesh.MockDataMeshTrackerComponent.ConnectMRMesh
	void ConnectMRMesh(UMRMeshComponent* InMRMeshPtr);                                                                       // [0x35cbad0] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x10];                                      // 0x0450   (0x0010)  MISSED
	UMaterialInterface*                                Material;                                                   // 0x0460   (0x0008)  
	UMaterialInterface*                                WireframeMaterial;                                          // 0x0468   (0x0008)  
	...
	unsigned char                                      UnknownData01_5[0x5];                                       // 0x0473   (0x0005)  MISSED
	UBodySetup*                                        CachedBodySetup;                                            // 0x0478   (0x0008)  
	TArray<UBodySetup*>                                BodySetups;                                                 // 0x0480   (0x0010)  
	unsigned char                                      UnknownData02_6[0x80];                                      // 0x0490   (0x0080)  MISSED


	/// Functions
	// Function /Script/MRMesh.MRMeshComponent.SetWireframeMaterial
	void SetWireframeMaterial(UMaterialInterface* InMaterial);                                                               // [0xaa0920] Native|Public|BlueprintCallable 
	// Function /Script/MRMesh.MRMeshComponent.SetWireframeColor
	void SetWireframeColor(FLinearColor& InColor);                                                                           // [0x35cbe00] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MRMesh.MRMeshComponent.SetUseWireframe
	void SetUseWireframe(bool bUseWireframe);                                                                                // [0x35cbd70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MRMesh.MRMeshComponent.SetEnableMeshOcclusion
	void SetEnableMeshOcclusion(bool bEnable);                                                                               // [0x35cbce0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MRMesh.MRMeshComponent.IsConnected
	bool IsConnected();                                                                                                      // [0x35cbca0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MRMesh.MRMeshComponent.GetWireframeColor
	FLinearColor GetWireframeColor();                                                                                        // [0x35cbc70] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MRMesh.MRMeshComponent.GetUseWireframe
	bool GetUseWireframe();                                                                                                  // [0x35cbc50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MRMesh.MRMeshComponent.GetEnableMeshOcclusion
	bool GetEnableMeshOcclusion();                                                                                           // [0x35cbc30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MRMesh.MRMeshComponent.ForceNavMeshUpdate
	void ForceNavMeshUpdate();                                                                                               // [0x35cbc10] Final|Native|Public|BlueprintCallable 
	// Function /Script/MRMesh.MRMeshComponent.Clear
	void Clear();                                                                                                            // [0x35cba10] Final|Native|Public|BlueprintCallable 
};
