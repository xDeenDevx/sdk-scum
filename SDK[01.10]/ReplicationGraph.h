...
public:
	...
	unsigned char                                      UnknownData01_6[0x3F8];                                     // 0x00B8   (0x03F8)  MISSED
};
...
{ 
public:
	UReplicationGraphNode_GridSpatialization2D*        GridNode;                                                   // 0x04A8   (0x0008)  
	UReplicationGraphNode_ActorList*                   AlwaysRelevantNode;                                         // 0x04B0   (0x0008)  
	TArray<FConnectionAlwaysRelevantNodePair>          AlwaysRelevantForConnectionList;                            // 0x04B8   (0x0010)  
	TArray<AActor*>                                    ActorsWithoutNetConnection;                                 // 0x04C8   (0x0010)  
...
public:
	...
	void ServerStopDebugging();                                                                                              // [0x2333f00] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerStartDebugging
	void ServerStartDebugging();                                                                                             // [0x22df990] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetPeriodFrameForClass
	void ServerSetPeriodFrameForClass(UClass* Class, int32_t PeriodFrame);                                                   // [0x4867db0] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetCullDistanceForClass
	void ServerSetCullDistanceForClass(UClass* Class, float CullDistance);                                                   // [0x4867ce0] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetConditionalActorBreakpoint
	void ServerSetConditionalActorBreakpoint(AActor* Actor);                                                                 // [0x2304490] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerPrintCullDistances
	void ServerPrintCullDistances();                                                                                         // [0x22700a0] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerPrintAllActorInfo
	void ServerPrintAllActorInfo(FString str);                                                                               // [0x4867c40] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerCellInfo
	void ServerCellInfo();                                                                                                   // [0x2304260] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ClientCellInfo
	void ClientCellInfo(FVector CellLocation, FVector CellExtent, TArray<AActor*> Actors);                                   // [0x4867af0] Net|NetReliableNative|Event|Public|HasDefaults|NetClient 
};
