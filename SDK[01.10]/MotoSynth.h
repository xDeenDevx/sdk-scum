...
{ 
public:
	UMotoSynthPreset*                                  MotoSynthPreset;                                            // 0x06C0   (0x0008)  
	float                                              RPM;                                                        // 0x06C8   (0x0004)  
	unsigned char                                      UnknownData00_6[0xB4];                                      // 0x06CC   (0x00B4)  MISSED


	/// Functions
	// Function /Script/MotoSynth.SynthComponentMoto.SetSettings
	void SetSettings(FMotoSynthRuntimeSettings& InSettings);                                                                 // [0x1789930] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MotoSynth.SynthComponentMoto.SetRPM
	void SetRPM(float InRPM, float InTimeSec);                                                                               // [0x1789860] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotoSynth.SynthComponentMoto.IsEnabled
	bool IsEnabled();                                                                                                        // [0x1789830] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotoSynth.SynthComponentMoto.GetRPMRange
	void GetRPMRange(float& OutMinRPM, float& OutMaxRPM);                                                                    // [0x1789750] Final|Native|Public|HasOutParms|BlueprintCallable 
};
